...
if __name__ == '__main__':
    ...
    SYNC_SESSIONS_ = [
        ...
        # 'Cagliari_2_5cams_Calib_2|-|400|2500', #
        'Cagliari_2_5cams_Perf_1|Cagliari_2_5cams_Calib_2|800|8500',
    ...
    for session_name_, calibration_session_name_, recon_start_frame_, recon_total_frames_ in [_.split('|') for _ in SYNC_SESSIONS_]:
        ...
        job = SyncedSession(session_name_, excel_sheet='Cagliari_Jun_2026')
